...
### Fixed
- Utils: Ensure isWoASite has a default if the site itself can't be found.
...
[0.4.3-alpha]: https://github.com/Automattic/jetpack-script-data/compare/v0.4.2...v0.4.3-alpha
