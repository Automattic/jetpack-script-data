...
### Added
- Add the My Jetpack script data type, including the products tab other packages link to.
...
[0.6.7-alpha]: https://github.com/Automattic/jetpack-script-data/compare/v0.6.6...v0.6.7-alpha
